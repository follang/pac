...
The `ast` module contains the syntax tree PAC produces after parsing. Most types track the C11
...
That design lets PAC represent C declarators without flattening away their structure.
...
PAC includes explicit AST nodes for extensions instead of hiding them:
...
When working with PAC, a useful order is:
